...
if __name__ == "__main__":
    ...
    parser.add_argument("-t", "--threshold", type=float, default=0.2, help="IV threshold")
    ...
    if args.crosstab is not None:
        ...
        if args.column is None:
            ...
            approved = "YES" if result.iv[0] > args.threshold else "NO"
            print(result)
            print("Are the groups differ? {}".format(approved))
            print("DEFINITION: The groups are heterogeneous if there exists a variable with an IV greater than {}".format(args.threshold))
        else:
